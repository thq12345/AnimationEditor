...
/**
 * Builds an animation from a given values and returns the model when ready.
 *
 * @param <Doc> a type of document.
 */
public interface AnimationBuilder<Doc> {
  ...
  AnimationBuilder<Doc> addMotion(String name,
      int t1, int x1, int y1, int w1, int h1, int r1, int g1, int b1, int d1,
      int t2, int x2, int y2, int w2, int h2, int r2, int g2, int b2, int d2);
